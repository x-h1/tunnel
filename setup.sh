...
function soket() {
    ...
    wget -O /usr/sbin/socdb.py "${GITHUB_CMD}/Python/socdb.py" >/dev/null 2>&1
    wget -O /usr/sbin/soceb.py "${GITHUB_CMD}/Python/soceb.py" >/dev/null 2>&1
    wget -O /usr/sbin/soced.py "${GITHUB_CMD}/Python/soced.py" >/dev/null 2>&1
    wget -O /usr/sbin/soceg.py "${GITHUB_CMD}/Python/soceg.py" >/dev/null 2>&1
    wget -O /usr/sbin/socep.py "${GITHUB_CMD}/Python/socep.py" >/dev/null 2>&1
    wget -O /usr/sbin/socey.py "${GITHUB_CMD}/Python/socey.py" >/dev/null 2>&1
    wget -O /usr/sbin/sochs.py "${GITHUB_CMD}/Python/sochs.py" >/dev/null 2>&1
    wget -O /usr/sbin/socpn.py "${GITHUB_CMD}/Python/socpn.py" >/dev/null 2>&1
    wget -O /usr/sbin/soctt.py "${GITHUB_CMD}/Python/soctt.py" >/dev/null 2>&1
    wget -O /usr/sbin/tunws.conf "${GITHUB_CMD}/Websocket/tunws.conf" >/dev/null 2>&1
    wget -O /etc/systemd/system/tunws@.service "${GITHUB_CMD}/Websocket/tunws.service" >/dev/null 2>&1
...
wget -O /etc/versisc "${GITHUB_REPO}/versi" >/dev/null 2>&1
...
apt install squid -y
wget -q -O /etc/squid/squid.conf "${GITHUB_REPO}/squid.conf" >/dev/null 2>&1
wget -q -O /etc/default/dropbear "${GITHUB_REPO}/dropbear" >/dev/null 2>&1
wget -q -O /etc/ssh/sshd_config "${GITHUB_REPO}/sshd_config" >/dev/null 2>&1
wget -q -O /etc/banner.com "${GITHUB_REPO}/banner.com" >/dev/null 2>&1
...
wget "${GITHUB_REPO}/udp-custom-linux-amd64" -O /etc/udpssh/udp-custom >/dev/null 2>&1
chmod +x /etc/udpssh/udp-custom
...
wget "${GITHUB_REPO}/udp.json" -O /etc/udpssh/config.json >/dev/null 2>&1
chmod +x /etc/udpssh/config.json
...
source <(curl -sL ${GITHUB_REPO}/ins-badvpn)
clear
judge "Instalasi vpn"
wget -O /etc/pam.d/common-password "${GITHUB_REPO}/common-password" >/dev/null 2>&1
chmod +x /etc/pam.d/common-password
source <(curl -sL ${GITHUB_REPO}/openvpn)
